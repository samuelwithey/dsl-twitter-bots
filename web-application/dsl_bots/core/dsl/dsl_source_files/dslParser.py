...
class dslParser ( Parser ):
    ...
    class Numeric_minuteContext(ParserRuleContext):
        ...
        def INT_0(self):
            return self.getToken(dslParser.INT_0, 0)
